...
class QuizMaster {
    ...
    async startQuiz(e) {
        ...
        if (!this.currentTheme.questions || this.currentTheme.questions.length === 0) {
            this.showError('Quiz ini belum memiliki soal');
            return;
        }
    ...
    resetQuestionForm() {
        ...
        choicesContainer.innerHTML = `
            <div class="choice-item">
                ...
                <button type="button" class="btn-danger remove-choice hidden">×</button>
            </div>
            <div class="choice-item">
        ...
        if (question.type === 'mc') {
            ...
            question.choices.forEach((choice, index) => {
                ...
                choiceItem.innerHTML = `
                    ...
                    <button type="button" class="btn-danger remove-choice ${index < 2 ? 'hidden' : ''}">×</button>
                `;
    ...
    addChoiceOption() {
        ...
        choiceItem.innerHTML = `
            ...
            <button type="button" class="btn-danger remove-choice">×</button>
        `;
